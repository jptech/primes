...
all: prime_cpu prime_cpu_mt prime_cuda prime_sieve

clean:
	rm -rf *.o prime_cpu prime_cpu_mt prime_cuda prime_sieve

prime_sieve: prime_sieve.c
	$(CC) $(CFLAGS) -fopenmp prime_sieve.c -o prime_sieve -lm
